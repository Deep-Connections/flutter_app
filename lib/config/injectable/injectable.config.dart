...
import 'package:deep_connections/services/auth/firebase_auth_service.dart'
    as _i4;
import 'package:deep_connections/services/chat/chat_read_storage.dart' as _i5;
...
// initializes the registration of main-scope dependencies inside of GetIt
  _i1.GetIt init({
    ...
    gh.factory<_i5.ChatReadStorage>(() => _i5.ChatReadStorage());
    gh.singleton<_i6.UserService>(_i6.UserService());
    gh.singleton<_i7.ProfileService>(
        _i8.FirebaseProfileService(gh<_i6.UserService>()));
