...
import 'package:deep_connections/screens/chat/components/message_banner.dart';
                    ...
                    child: Column(
                      children: [
                        ...
                        switch (message) {
                          ...
                          MessageUnmatch() => MessageBanner(
                              loc.messages_unmatchedWithYou(
                                  message.senderFirstName)),
                          MessageDelete() => MessageBanner(
                              loc.messages_matchDeletedAccount(
                                  message.senderFirstName)),
                        },
                      ],
                    ),
