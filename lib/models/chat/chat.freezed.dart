...
class _$ChatImpl with DiagnosticableTreeMixin implements _Chat {
  const _$ChatImpl({this.id, final List<String>? participantIds})
  ...
  String toString({DiagnosticLevel minLevel = DiagnosticLevel.info}) {
    return 'Chat(id: $id, participantIds: $participantIds)';
  }
  ...
  int get hashCode => Object.hash(
      runtimeType, id, const DeepCollectionEquality().hash(_participantIds));
...
abstract class _Chat implements Chat {
  const factory _Chat({final String? id, final List<String>? participantIds}) =
      _$ChatImpl;
