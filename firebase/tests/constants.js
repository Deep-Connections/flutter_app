...
const FunctionErrors = {
    ...
    UNAUTHENTICATED: 'unauthenticated', // (401) - The request does not have valid authentication credentials for the operation.
    PERMISSION_DENIED: 'permission-denied', // (403) - The caller does not have permission to execute the specified operation.
    NOT_FOUND: 'not-found', // (404) - Specified resource was not found.
    ABORTED: 'aborted', // (409) - Operation was aborted, typically due to a concurrency issue like the transaction aborts, etc.
    ALREADY_EXISTS: 'already-exists', // (409) - The resource being created already exists.
    FAILED_PRECONDITION: 'failed-precondition', // (412) - Operation was rejected because the system is not in a state required for the operation's execution.
    RESOURCE_EXHAUSTED: 'resource-exhausted', // (429) - Some resource has been exhausted, perhaps a per-user quota, or perhaps the entire file system is out of space.
